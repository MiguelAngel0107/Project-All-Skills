...
export default function ReviewsProdruct() {
  return (
    <section>
      <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8 bg-gray-800 bg-opacity-40 rounded-lg">
        <h2 class="text-xl font-bold sm:text-2xl dark:text-white">Customer Reviews</h2>
        ...
        <div class="mt-8 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-2">
          <blockquote>
            <header class="sm:flex sm:items-center sm:gap-4">
              ...
              <p class="mt-2 font-medium sm:mt-0 dark:text-white">
